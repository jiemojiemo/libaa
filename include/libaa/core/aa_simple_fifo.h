...
#ifndef LIBAA_AA_SIMPLE_FIFO_H
#define LIBAA_AA_SIMPLE_FIFO_H
...
public:
    ...
    size_t size() const {
        return write_pos_ >= read_pos_ ? (write_pos_ - read_pos_) : (write_pos_ + capacity() - read_pos_ + 1);
    }
